module github.com/NJUPT-SAST/sast-shop-v2/internal/services/spotservice
...
require (
	...
	github.com/NJUPT-SAST/sast-shop-v2/internal/pkg v0.0.0-20260703071214-a567209ab869
